...
<div class="layout">
    <div class="hpage1">
        ...
        <div class="hds">
            ...
            <h5><?php echo (C("CURRENCY_SYMBOL")); echo ($delayFee); ?></h5>
            <a class="qmbtn" href="#" id="payfee">Préstamo extendido</a>
            <dl class="dls">
                <dd>
                    <h4>Monto total del préstamo</h4>
                    <h6><?php echo (C("CURRENCY_SYMBOL")); ?> <?php echo ($delayFee); ?></h6>
                </dd>
                <dd>
                    <h4>Fecha de pago</h4>
                ...
                <dd>
                    <h4>Próxima cantidad de pago</h4>
                    <h6><?php echo (C("CURRENCY_SYMBOL")); ?> <?php echo ($needRepayMoney); ?></h6>
                </dd>
                <dd>
                    <h4>Fecha de pago</h4>
                    <h6><?php echo ($nextRepayDay); ?></h6>
                </dd>
            </dl>
        </div>
        <div class="text">
            Si el pago se ha efectuado y el reembolso aún no se ha completado, por favor proporcione el número de comprobante de la transacción y una captura de pantalla del mismo. Revisaremos y procesaremos dentro de media hora.
        </div>
        <div class="bds">
            <div class="dfsw">
