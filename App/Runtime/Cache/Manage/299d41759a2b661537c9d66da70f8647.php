			...
			<div class="page-content height-full">
				<div class="page-brand-info vertical-align animation-slide-left hidden-xs">
					<div class="page-brand vertical-align-middle">
						<!--<div class="brand">
							<img class="brand-img" src="__PUBLIC__/Manage/images/apple-touch-icon.png" height="50">
						</div>-->
						<h2 class="hidden-sm">小额贷款管理系统</h2>
						<ul class="list-icons hidden-sm">
							<li>
								<i class="wb-check" aria-hidden="true"></i> 小额贷款系统</li>
							<li><i class="wb-check" aria-hidden="true"></i> 最大程度上帮助企业节省时间成本和费用开支</li>
							<li><i class="wb-check" aria-hidden="true"></i> 小额贷款系统 紧贴业务特性，涵盖了大量的常用组件和基础功能，最大程度上帮助企业节省时间成本和费用开支。
							</li>
						</ul>
						<div class="hidden-sm">
							<a href="tencent://message/?uin=807324887&Site=管理系统&Menu=yes" class="btn btn-info open-kf"><i class="icon wb-user"></i> 联系客服</a>
						</div>
					</div>
				</div>
				<div class="page-login-main animation-fade">
					<div class="vertical-align">
						<div class="vertical-align-middle">
							...
							<h3 class="hidden-xs">小额贷款管理系统</h3>
					...
					<!--<footer class="page-copyright">
						<p>CvPHP1.0 西安优果电子科技有限公司 &copy;
							<a href="http://www.xauguo.com" target="_blank">www.xauguo.com</a>
						</p>
					</footer>-->
				</div>
			</div>
